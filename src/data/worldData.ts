...
lore: "Frostspire Theocracy ตั้งอยู่ท่ามกลางเทือกเขาน้ำแข็งและสภาพอากาศที่โหดร้าย เมืองถูกสร้างขึ้นเพื่อความอยู่รอดเป็นหลัก ทั้งกำแพง ป้อมปราการ และมหาวิหารต่างมีบทบาทในชีวิตประจำวัน\n\nศรัทธาเป็นศูนย์กลางของสังคม ผู้คนเชื่อว่าความหนาวและภัยจากภายนอกเป็นบททดสอบที่ต้องฝ่าฟัน อัศวินและนักบวชจึงมีบทบาทสำคัญในการปกป้องเมือง\n\nมีรายงานการพบมังกรและสิ่งมีชีวิตขนาดใหญ่ในภูเขา แม้จะไม่เกิดขึ้นบ่อย แต่ก็เพียงพอที่จะทำให้ภัยคุกคามนี้ยังคงเป็นเรื่องจริงสำหรับผู้คนในภูมิภาค",    population: [
  ...
  icon: "tundra",
  color: "#9FBAD6",
  glowColor: "rgba(159,186,214,0.4)",
  ...
  terrain: "Frozen Tundra & Ice Mountains",
  capital: "Farrimgard",
  ruler: "High King Lohtallan Daguhim",
  government: "Dwarven Monarchy with Regional Powers",

  economy: "Mining, Fishing, Metalwork & Limited Trade",
  culture: "Survival, Tradition & Harsh Honor",
  danger: "Blizzards, Giants, Beasts & Isolation",

  suitedFor: "Fighter, Ranger, Barbarian, Cleric",

  summary: "A land of ice and endurance — where survival is earned, not given.",

  lore: `
Isheim คือดินแดนทางเหนือของ Aetherra ที่ถูกปกคลุมด้วยน้ำแข็งและความหนาวเย็นเกือบตลอดทั้งปี แสงอาทิตย์ปรากฏเพียงช่วงเวลาสั้นๆ ในแต่ละวัน และพายุหิมะสามารถกลืนทุกสิ่งได้โดยไม่ทันตั้งตัว

ดินแดนแห่งนี้ไม่ได้เต็มไปด้วยเวทมนตร์ที่แสดงออกอย่างชัดเจน หากแต่เต็มไปด้วย “เรื่องเล่า” — คริสตัลผิดปกติ เมืองร้างที่ไม่มีใครกล้าเข้าใกล้ และกำแพงน้ำแข็งทางเหนือที่ไม่มีใครรู้ว่ามีอะไรอยู่เบื้องหลัง

อารยธรรมหลักของ Isheim ถูกสร้างโดยเหล่า Dwarf ที่อพยพหนีภัยพิบัติมาจากแดนตะวันตก พวกเขาสร้างเมือง Farrimgard บนซากนครของ Fire Giant และพัฒนาเทคโนโลยีการตีเหล็กและสงครามขึ้นมาเพื่อความอยู่รอด

อย่างไรก็ตาม Isheim ไม่ได้มีเพียง Dwarf — ชนเผ่า Goliath ยังคงดำรงชีวิตแบบเร่ร่อนในแดนตอนใน ขณะที่มนุษย์ได้สร้างชุมชนของตนเองขึ้นหลังจากการล่มสลายของระบบทาส

ในปัจจุบัน Isheim เพิ่งเปิดรับโลกภายนอกผ่านเมืองท่า Nyvonvik การมาถึงของผู้คนจาก Aetherra ได้นำโอกาสและความเปลี่ยนแปลง…รวมถึงความตึงเครียดที่ยังไม่อาจคาดเดาได้

และเหนือสุดของดินแดนนี้ มีกำแพงน้ำแข็งขนาดมหึมาตั้งอยู่ — ไม่มีใครรู้ว่ามันถูกสร้างขึ้นเพื่อป้องกันอะไร…หรือกักขังอะไรไว้
`,

  population: [
    { race: "Dwarf", percent: 50, role: "Rulers / Smiths / Nobility" },
    { race: "Human", percent: 30, role: "Workers / Settlers / Survivors" },
    { race: "Goliath", percent: 15, role: "Nomadic Tribes / Hunters" },
    { race: "Others", percent: 5, role: "Outsiders / Traders" },
  ],

  traits: [
    "Extreme cold defines daily life",
    "Magic exists but is subtle and rare",
    "Strong class and cultural divisions",
    "Ancient conflicts still shape the present",
    "Newly opened to the outside world",
  ],

  knownFor: [
    "Farrimgard (Dwarven capital)",
    "Nyvonvik (trade port)",
    "Vonvik (abandoned cursed city)",
